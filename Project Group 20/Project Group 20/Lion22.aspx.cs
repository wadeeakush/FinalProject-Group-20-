...
namespace Dyslaxia
{
    public partial class Lion22 : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Lion23.aspx");
        }

        protected void PlayButton_Command(object sender, CommandEventArgs e)
        {
            SoundPlayer splayer = new SoundPlayer(@"C:\Users\Wadeea Abukush\Dyslaxia\Dyslaxia\Sounds\22.wav");
            splayer.Play();
        }

        protected void PrevButtun_Command(object sender, CommandEventArgs e)
        {
            Response.Redirect("Lion21.aspx");
        }
    }
}