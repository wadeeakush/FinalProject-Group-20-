...
namespace Dyslaxia
{
    public partial class Lion2 : System.Web.UI.Page
    {
        ...
        {
            SoundPlayer splayer = new SoundPlayer(@"C:\Users\Wadeea Abukush\Dyslaxia\Dyslaxia\Sounds\2.wav");
            splayer.Play();
        }

        protected void PrevButtun_Command(object sender, CommandEventArgs e)
        {
            Response.Redirect("Lion1.aspx");
        }
    }
}