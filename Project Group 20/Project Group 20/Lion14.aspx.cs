...
namespace Dyslaxia
{
    public partial class Lion14 : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Lion15.aspx");
        }

        protected void PlayButton_Command(object sender, CommandEventArgs e)
        {
            SoundPlayer splayer = new SoundPlayer(@"C:\Users\Wadeea Abukush\Dyslaxia\Dyslaxia\Sounds\14.wav");
            splayer.Play();
        }

        protected void PrevButtun_Command(object sender, CommandEventArgs e)
        {
            Response.Redirect("Lion13.aspx");
        }
    }
}