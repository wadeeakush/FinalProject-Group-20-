...
namespace Dyslaxia
{
    public partial class Lion12 : System.Web.UI.Page
    {
        ...
        {
            SoundPlayer splayer = new SoundPlayer(@"C:\Users\Wadeea Abukush\Dyslaxia\Dyslaxia\Sounds\12.wav");
            splayer.Play();
        }

        protected void PrevButtun_Command(object sender, CommandEventArgs e)
        {
            Response.Redirect("Lion11.aspx");
        }
    }
}